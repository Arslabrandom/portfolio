...
Array.from(homebtn, (btn) => {
    btn.addEventListener('click', () => {
        window.location.href = "http://192.168.234.139:3000/";
    });
});

function downloadCV() {
    window.location.href = 'http://192.168.234.139:3000/downloadcv';
};

function hireme() {
    window.location.href = "http://192.168.234.139:3000/hireme";
};